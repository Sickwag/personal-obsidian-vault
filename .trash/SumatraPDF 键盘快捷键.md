### File menu [#](https://www.sumatrapdfreader.org/docs/Keyboard-shortcuts#file-menu)
...
### Go To menu [#](https://www.sumatrapdfreader.org/docs/Keyboard-shortcuts#go-to-menu)
...
### Favorites menu [#](https://www.sumatrapdfreader.org/docs/Keyboard-shortcuts#favorites-menu)

- `Ctrl + B` - Add current page to favorites

### View menu [#](https://www.sumatrapdfreader.org/docs/Keyboard-shortcuts#view-menu)
...
### Zoom menu [#](https://www.sumatrapdfreader.org/docs/Keyboard-shortcuts#zoom-menu)
...
### Navigation [#](https://www.sumatrapdfreader.org/docs/Keyboard-shortcuts#navigation)
...
### Viewing state [#](https://www.sumatrapdfreader.org/docs/Keyboard-shortcuts#viewing-state)
...
### Actions [#](https://www.sumatrapdfreader.org/docs/Keyboard-shortcuts#actions)
...
### Tabs [#](https://www.sumatrapdfreader.org/docs/Keyboard-shortcuts#tabs)
...
### Annotations [#](https://www.sumatrapdfreader.org/docs/Keyboard-shortcuts#annotations)

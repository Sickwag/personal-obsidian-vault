...
- 这与 C++中的 [C++ Runoob Tutoral \> 虚函数](C++%20Runoob%20Tutoral.md#虚函数)类似，虚函数也有类似的虚函数表加快查找速度
...
- 默认方法可以较为抽象地类比 C++中的 [C++ Runoob Tutoral \> 纯虚函数](C++%20Runoob%20Tutoral.md#纯虚函数)，必须在子类中实现，否则无法实例化，向父类中添加功能，所有子类中必须都要实现，否则报错。
...
### 为什么需要抽象类
同 C++中的 [C++ Runoob Tutoral \> 纯虚函数](C++%20Runoob%20Tutoral.md#纯虚函数)，使用可以强制开发者必须在后续子类中实现方法，减少犯错

...
- 概念
    ...
    - 幻灯片母版
        ...
        一般选择中提到对所有幻灯片进行统一操作的时候就需要用到幻灯片母版
...
- 插入水印
    ...
    在Word中用艺术字，然后调整至相应的样式之后保存为图片，导入PowerPoint中
...
- 调整smartart元素动画
    ...
    4. “逐个按分支”即“逐个”效果是按照一个一个显示，默认按照分支逐个显示，显示完一个分支之后在显示下一个分支。
- 对不同类别的产品介绍

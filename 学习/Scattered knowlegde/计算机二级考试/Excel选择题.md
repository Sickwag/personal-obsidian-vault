...
- 合并表格
    ...
    - 使用组合功能‘
        ...
        2. 打开新建的Excel文件，找到数据菜单栏中的获取和转换数据功能区，点击获取数据功能，在其下拉框中选择【自文件】-【从文件夹】。
...
- 公式审核
    ...
    - “审阅”选项卡的“校对”组中的功能是做拼写检查、信息检索和同义词库；
    - “审阅”选项卡的“更改”组中的功能是用于保护或修订工作簿、工作表等。
    - “函数库”组中的各个功能是实现快速插入各种函数
    
- 概念：主题、
    - 主题：主题是一组格式选项，包括颜色、字体和效果。可以自定义文档主题，方法为更改已使用的颜色、字体或线条和填充效果。对一个或多个这样的主题组件所做的更改将立即影响活动文档中已经应用的样式。（可以类比于Word中的主题）
...
- 数据有效性
    ...
    需要提示错误信息或需要发给别人填写信息的时候需要使用数据验证而
...
- Excel不能做的事
    - 不能插入迷你散点图
    - 在同一个单元格内需要输入两行数据（换行）的时候，不能像Word中一样按下shift+enter，要alt+enter
- Excel中能做的事
    - 能插入折线图,柱形图,盈亏图等
...
- 拆分窗口
    ...
    拆分的前提是你的表格拆分成若干块（可以鼠标调整拆分线）之后不同的部分之间可以分别进行滚动，比如分别冻结了窗格
...
- 不显示网格线
    ...
    在 页面布局 旋蒸卡中的 工作表选项 组中选择不显示网格线
    
- 选中较大范围的工作表数据区域
    
    - 选中工作表中某一个单元格之后Ctrl+a表示选中当前数据区域
